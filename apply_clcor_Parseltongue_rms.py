...
## Inputs
UVFITSFILESpath = '../../../multi_source_s_cal/sub_mm/UV/'
IMAGEFITSFILESout = '../RMS/IM/'
UVFITSFILESout = '../RMS/TASAV/'
AIPS.userno = 15
disk = 1
...
for file in os.listdir(UVFITSFILESpath):
    if file.endswith('.UV'):
	if os.path.isfile(UVFITSFILESout+file[:8]+'_PBCOR_TASAV.fits') == False:
